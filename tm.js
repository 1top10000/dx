...
const acpt = (px, py, px, t, ai, aj, ak) => {let sin = Math.sin(t / 2); const cos = Math.cos(t / 2); const tmp0 = hqp(cos, sin * ai, sin * aj, sin * ak, 0, px, py, pz); sin = Math.sin(t / -2); return hqp(tmp.w, tmp.i, tmp.j, tmp.k, cos, sin * ai, sin * aj, sin * ak); }
